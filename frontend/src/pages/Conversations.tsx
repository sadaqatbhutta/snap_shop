        ...
        <div className="flex-1 flex flex-col">
          <div className="p-4 border-b border-gray-200 flex items-center justify-between bg-white">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="hover:text-indigo-600 text-gray-400" title="Customer Info" onClick={() => document.getElementById('customer-sidebar')?.scrollIntoView()}><Info className="w-5 h-5" /></button>
              <button className="hover:text-red-500 text-gray-400" title="Close Conversation" onClick={() => {
                if (businessId && selectedId && confirm('Close this conversation?')) {
                  updateDoc(doc(db, `businesses/${businessId}/conversations`, selectedId), { status: 'closed', updatedAt: new Date().toISOString() });
                }
