...
import {
  ...
  Tag, Hash, ChevronRight, X, Calendar, MessageCircle, Filter, Loader2
} from 'lucide-react';
...
import {
  collection, query, orderBy, onSnapshot, addDoc, deleteDoc, doc, getDocs, where
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-indigo-600 text-white">
                <h2 className="text-xl font-bold flex items-center gap-2"><Users className="w-6 h-6" /> Create New Segment</h2>
